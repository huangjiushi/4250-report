...
```
The fourth comparison is on the combination of Alkphos and SGPT using MANOVA. There are two groups of figures. We will focus on the GROUP figures which are related to our study. Within the GROUP figures, there are four test statistics for MANOVA, Pillaiâ€™s Trace, Wilksâ€™ Lambda, Hotellingâ€™s Trace, Royâ€™s Largest Root. We will decide whether to reject the null hypothesis based on these four test statistics. All four statistics show the 0.000 significance level. Hence we safely reject the null hypothesis and conclude that the difference between Indian patients and US patients on the mean value of Alkphos and SGPT exists.
...
In conclusion, experiment 2 shows that there are significant differences between US and Indian liver patients. It is proved by the statistical differences between US and Indian liver patientsâ€™ data on their common attributes and the all combinations of their common attributes.
